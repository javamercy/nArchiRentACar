...
public class RefreshTokenConfiguration : IEntityTypeConfiguration<RefreshToken>
{
    public void Configure(EntityTypeBuilder<RefreshToken> builder)
    {
        ...
        builder.Property(rt => rt.Expires).HasColumnName("Expiration").IsRequired();
        builder.Property(rt => rt.CreatedByIp).HasColumnName("CreatedByIp").IsRequired();
        builder.Property(rt => rt.Revoked).HasColumnName("Revoked").IsRequired();
        ...
        builder.Property(rt => rt.ReasonRevoked).HasColumnName("RevokedDate");
